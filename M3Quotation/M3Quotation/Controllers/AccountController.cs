...
using M3Quotation.DataAccess;
using M3Quotation.Models;
...
namespace M3Quotation.Controllers
{
    public class AccountController : Controller
    {
        ...
        public void VerificationEmail(string email, string activationCode)
        {
            ...
            var fromEmail = new MailAddress("info@m3technologies.com.mx", "Activation Account");
            var toEmail = new MailAddress(email);

            var fromEmailPassword = "Saltillo2019";
            ...
            {
                Host = "mail.m3technologies.com.mx",
                Port = 25,
                EnableSsl = false,
